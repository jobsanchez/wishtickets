-- Fix report tickets: show per-ticket amount instead of full booking total
-- Previously each ticket row showed b.total_cents (booking total), so a 5-ticket
-- booking displayed the full amount 5 times. Now each row shows total_cents / ticket_count.
