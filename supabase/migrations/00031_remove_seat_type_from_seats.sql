-- Remove seat_type from event_seats and seats (venue)

-- 1. Drop seat_type from event_seats
ALTER TABLE public.event_seats DROP COLUMN IF EXISTS seat_type;

-- 2. Drop seat_type from seats (venue)
ALTER TABLE public.seats DROP COLUMN IF EXISTS seat_type;

-- 3. Update get_event_availability to not return seat_type
