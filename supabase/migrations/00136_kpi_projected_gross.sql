-- Add projected_total_gross_cents to dashboard metrics.
-- Projected Total Gross = revenue if venue sold out at current avg price per seat.
  ...
  RETURN (
    ...
    SELECT jsonb_build_object(
      ...
      'kpis', jsonb_build_object(
        ...
        'projected_total_gross_cents', CASE
          WHEN v_occupied > 0 AND v_total_capacity > 0
          THEN (ROUND((v_gross_revenue::numeric / v_occupied) * v_total_capacity)::bigint)
          ELSE v_gross_revenue
        END,
