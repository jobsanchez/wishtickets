-- Fix get_admin_seat_assignments: show correct seat labels for
-- 1. admin_assignment_items with seat_id (join event_seats for row_label/seat_number + section)
-- 2. confirmed assignments with no items: fallback to tickets (booking_id)
