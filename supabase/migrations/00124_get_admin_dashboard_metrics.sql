-- Dashboard metrics for Reports page: KPIs, section sales, payment methods, VSS breakdown, event-day data.
-- Auth: view_sales_analytics or admin/super_admin (same as get_admin_report_summary).
