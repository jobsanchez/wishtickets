-- Priority guests RPC: same as 00209 after wheelchair fields were removed from the payload.
-- Apply this if an older 00209 revision already ran with wheelchair_* / wheelchair column.
