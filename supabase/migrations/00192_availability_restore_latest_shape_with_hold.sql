-- Restore latest get_event_availability payload shape (canvases/background/column_direction)
-- while keeping Seat Hold support.
...
BEGIN
  ...
  -- Seat Hold is treated as unavailable in buyer availability.
