-- Fix get_admin_confirmed_bookings_for_resend email type mismatch (varchar -> text).
-- Cast auth.users.email to text so it matches the declared buyer_email text column.
