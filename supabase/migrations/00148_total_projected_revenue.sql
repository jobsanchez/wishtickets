-- Add Total Projected Revenue: (capacity × price) - complimentary_value per section.
-- Replaces projected_total_gross with total_projected_revenue_cents based on seat pricing.
