-- Update get_admin_confirmed_bookings_for_resend to use profiles.email and profiles.full_name
-- instead of auth.users.email. This matches how buyer contact info is stored in the app.
